...
//   //     const rawWeight = row.feedWeight !== "" && row.feedWeight !== null && row.feedWeight !== undefined
//   //       ? row.feedWeight
//   //       : row.feedin;  // fallback to feedin for the last cycle

//   //     const feedWeightInt = rawWeight !== null && rawWeight !== undefined && rawWeight !== ""
...
//         from_time: row.startTime,
//         feed_weight: rawWeight ? parseInt(rawWeight, 10) : 0,
//         worker_name: validWorker,
//       };
//     });
...
//     const res = await axios.post(`${BASEURL}/tasksubmit/`, payload);
